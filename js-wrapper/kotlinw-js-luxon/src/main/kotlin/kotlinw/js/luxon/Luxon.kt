...
open external class DateTime {
    open var day: Number
    open var daysInMonth: Number
    open var daysInYear: Number
    open var hour: Number
    open var invalidReason: String?
    open var invalidExplanation: String?
    open var isInDST: Boolean
    open var isInLeapYear: Boolean
    open var isOffsetFixed: Boolean
    open var isValid: Boolean
    open var locale: String
    open var millisecond: Number
    open var minute: Number
    open var month: Number
    open var monthLong: String
    open var monthShort: String
    open var numberingSystem: String
    open var offset: Number
    open var offsetNameLong: String
    open var offsetNameShort: String
    open var ordinal: Number
    open var outputCalendar: String
    open var quarter: Number
    open var second: Number
    open var weekNumber: Number
    open var weekYear: Number
    open var weekday: Number
    open var weekdayLong: String
    open var weekdayShort: String
    open var weeksInWeekYear: Number
