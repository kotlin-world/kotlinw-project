...
actual class ZoneOffset(internal val totalMinutes: Int) : ZoneId(), Comparable<ZoneOffset> {
    ...
    override fun equals(other: Any?) = other is ZoneOffset && totalMinutes == other.totalMinutes

    override fun hashCode() = totalMinutes
